...
def main() -> None:
	...
	with st.sidebar:
		...
		st.link_button("Open GitHub Repository", "https://github.com/EbiAraz/semantic-RAG", use_container_width=True)
		st.link_button("Open Hugging Face Space", "https://huggingface.co/spaces/EbiAraz/semantic-rag", use_container_width=True)
		st.link_button("Open README", "https://github.com/EbiAraz/semantic-RAG/blob/main/README.md", use_container_width=True)
